            ...
            <nav>
                <div>
                    <ul class="main-nav" id="navBar">
                        ...
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Blog</a></li>
                        <li><a class="cta" href="http://localhost/Login-Register-Form/"><button class="btn-login">Logout</button></a></li>
                    </ul>
                </div>
            </nav>
            <div>
            <div class="btn-menu">
            <button class="profile-btn"><i class="fa-solid fa-user profile-icon" id="iconBtn2"></i></button> 
            </div>
        </div>
        </header>
                     ...
                     <?php } ?> 
                       ...
                       <div class="form-input-group">
                               ...
                               <?php if (isset($_GET['uname'])) { ?>
                                   <input type="text" name="uname" placeholder="Change Username" value="<?php echo $_GET['uname']; ?>" class="form-input"><br>
                               <?php }else{ ?>
                               <input type="text" name="uname" placeholder="Change Username"><br>
                               <?php }?> 
                       </div>
                       ...
                       <div class="form-input-group">
                               ...
                               <input type="password" name="password"  placeholder="Change Password" class="form-input"><br>
